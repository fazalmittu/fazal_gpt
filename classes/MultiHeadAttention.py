...
from classes.SingleHeadAttention import EDSingleHeadAttention, SingleHeadAttention
...
class EDMultiHeadAttention(nn.Module):
    """ multiple heads of self-attention in parallel """
    ...
    def __init__(
        ...
        # combine all single heads
        self.heads = nn.ModuleList([EDSingleHeadAttention(self.embedding_dim, self.head_size, self.block_size, self.dropout, self.masked) for _ in range(n_heads)])
